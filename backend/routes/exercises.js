...
// this will give all the exercise-list to the front-end by finding all documents in the Exercise db 
...
router.route('/add').post((req, res) => {
  ...
  // below lines of code will create a new entry or document in the Exercise Db
